...
<style scoped>
.skill-cat-card { border: 1px solid #e8e8e8; border-radius: 8px; padding: 10px; background: #fafafa; display: flex; flex-direction: column; gap: 6px; overflow: hidden; }
.skill-cat-header { display: flex; align-items: center; gap: 6px; }
.cat-name-input { flex: 1; min-width: 0; padding: 5px 8px; border: 1px solid #d9d9d9; border-radius: 6px; font-size: 0.82rem; font-weight: 600; }
.cat-name-input:focus { outline: none; border-color: #667eea; }
.entry-remove-btn { width: 26px; height: 26px; min-width: 26px; border: none; background: #f0f0f0; border-radius: 6px; font-size: 1rem; cursor: pointer; color: #999; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
